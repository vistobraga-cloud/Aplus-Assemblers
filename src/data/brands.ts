...
export const equipmentBrands: EquipmentBrand[] = [
  ...
  { name: 'Sole', logo: 'sole', category: 'cardio' },
  { name: 'ProForm', logo: 'proform', category: 'cardio' },
  { name: 'Horizon', logo: 'horizon', category: 'cardio' },
  { name: 'Concept2', logo: 'concept2', category: 'cardio' },
  { name: 'WaterRower', logo: 'waterrower', category: 'cardio' },
  ...
  { name: 'Bowflex', logo: 'bowflex', category: 'strength' },
  { name: 'REP Fitness', logo: 'rep-fitness', category: 'strength' },
  { name: 'Rogue', logo: 'rogue', category: 'strength' },
  { name: 'Titan', logo: 'titan', category: 'strength' },
  { name: 'Body-Solid', logo: 'body-solid', category: 'strength' },
