...
export const en = {
  ...
  gallery: {
    ...
    items: [
      'A rack, bench and mirror in a basement gym lit blue',
      'A half rack and bench on rubber flooring, one plate loaded',
      'A single-stack home gym with its bench, against a bare wall',
      'A Pilates reformer and tower set up beside a window',
      'Bolts, tools and boxed parts sorted on a table before anything is built',
      'A treadmill built and running in a finished basement',
      'A functional trainer in an unfinished basement, hardware laid out on the mats',
      'An Assault air bike beside the crate it came out of, in a garage',
    ],
  },
