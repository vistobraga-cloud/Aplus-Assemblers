...
export const es: Dict = {
  ...
  gallery: {
    ...
    items: [
      'Un rack, un banco y un espejo en un sótano con luz azul',
      'Medio rack y banco sobre piso de goma, con un disco cargado',
      'Un gimnasio de casa de una torre, con su banco, contra la pared',
      'Un reformer de Pilates con torre, montado junto a una ventana',
      'Tornillos, herramientas y piezas ordenados en una mesa antes de armar',
      'Una caminadora armada y funcionando en un sótano terminado',
      'Una torre funcional en un sótano sin terminar, con la tornillería sobre los tapetes',
      'Una bicicleta de aire Assault junto a la caja de la que salió, en un garaje',
    ],
  },
